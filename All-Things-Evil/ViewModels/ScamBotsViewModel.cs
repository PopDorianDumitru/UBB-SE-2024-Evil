...
{
    public class ScamBotsViewModel : IScamBotsViewModel
    {
        private ICreditCardValidator creditCardInformationValidator;
        private ICreditCardService creditCardController;
        public ScamBotsViewModel(ICreditCardValidator creditCardInformationValidator, ICreditCardService creditCardController)
        {
